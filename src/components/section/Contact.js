            ...
            <div className="git-cont row">
                <div className="col-12 col-sm-6 half">
                    <form action={contact.contactUrl ? contact.contactUrl : "https://formspree.io"} method={contact.contactUrl ? "POST" : "GET"}>
                        ...
                        <input type="mail" id="mailid" name="Email" placeholder="Your Email" required></input>
                ...
                <div className="inline-block">
                    ...
                    {social.resume && <a title="Download Resume" href={social.resume} download><i className="fas fa-file-download"></i></a>}
                </div>
                </div>
            </div>
            </div>
